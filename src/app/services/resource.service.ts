...
export class ResourceService {
    ...
    async getOneResource(idModule: string, idResource: string): Promise<any> {
        return new Promise(resolve => this.http.get<any>(`${this.app.URL}/module/${idModule}/${idResource}`).subscribe(
            res => {
    ...
    clone(idPath, resource: ResourceModel): Observable<any> {
        const params = {
            idModule: resource._idResource,
            idUser: sessionStorage.getItem('idUser')
        };

        return this.http.post<any>(`${this.app.URL}/module/${idPath}/${resource._idModule}/${resource._idResource}/clone`, params, {
    ...
    deleteResource(resource: ResourceModel): Observable<any> {
        ...
        return this.http.delete<any>(`${this.app.URL}/module/${resource._idModule}/${resource._idResource}`, {
            headers: header,
            params: param
        });
